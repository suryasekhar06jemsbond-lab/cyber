...
This restriction is recommended for maximum compatibility.
...
If `finalSize` is `-1`, it means the final size is too hard to guess before processing the input file data.
