...
- Auto-apply icon theme on Nyx language activation.
- Use refined `cy-logo.png` as language and file icon.

## 0.1.1

- Updated extension metadata and naming.
- Updated icon theme integration.
